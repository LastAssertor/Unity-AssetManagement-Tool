...
namespace UnityAssetManagementTool {
    ...
    public static class PathUtility {
        ...
        public static bool IsAssetPath(this string path) {
            return path.Contains(ASSETS_FOLDER);
        }

        public static bool IsResourcesPath(this string path) {
            return path.Contains(RESOURCES_FOLDER);
        }
        ...
        public static string GetAssetPath(this string fileFullPath) {
            return Path.Combine(ASSETS_FOLDER_NAME, fileFullPath.Substring(ASSETS_FOLDER));
        }
        ...
        public static string GetResourcesPath(this string assetPath) {
             ...
             */
            return assetPath.Substring(RESOURCES_FOLDER)
